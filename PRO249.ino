...
#define IO_USERNAME "WildFox"
#define IO_KEY      "aio_tQFO36duXkbbBrOfuVw75SetRh1e"
...
Adafruit_MQTT_Publish tc = Adafruit_MQTT_Publish(&mqtt , IO_USERNAME"/feeds/tempC");
Adafruit_MQTT_Publish tf = Adafruit_MQTT_Publish(&mqtt , IO_USERNAME"/feeds/tempF");
Adafruit_MQTT_Publish tk = Adafruit_MQTT_Publish(&mqtt , IO_USERNAME"/feeds/tempK");
...
void loop() {
  ...
  String val = String(tempc) + " *C" + "\t" + String(tempf) + " *F" + "\t" + String(tempk) + " *K" + "\t" + String(humidity) + " %RH" + "\t" + String(dew_point) + " *C";
